...
(function (UserServiceBindings) {
    UserServiceBindings.USER_SERVICE = core_1.BindingKey.create('services.CustomUserService');
    UserServiceBindings.DATASOURCE_NAME = 'jwtdb';
    UserServiceBindings.USER_REPOSITORY = 'repositories.CustomUserRepository';
